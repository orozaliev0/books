...
import bookImg from "../../img/image 1.png";
            ...
            <div className="container">
                <div className="allBooks">
                        ...
                        <div className='allBooks--block__two'>
                            {
                                book2.map(el => (
                                    <div className="allBooks--block__two--aboutBooks">
                                        <h1 className="allBooks--block__two--aboutBooks__title">С какой книги
                                            начать?</h1>
                    ...
                    <div className={"pagination"}>
                        <button><GrPrevious className={"pag"}/></button>
                        <button className={"numPage"}>1</button>
                        <button><GrNext className={"pag"}/></button>
                    </div>
                </div>
            </div>
        </div>
